...
Khóa luận này trình bày quá trình tìm hiểu, thiết kế và hiện thực một
...
Execute--Order--Validate của Hyperledger Fabric, gồm bốn thành phần độc
lập giao tiếp qua mạng ngang hàng \texttt{libp2p}: (1)~Core Service
...
xác nhận (endorsement); (2)~Ordering Service --- trái tim đồng thuận
...
(3)~Committing Peer kiểm tra tính hợp lệ về mật mã của block và ghi
vĩnh viễn vào sổ cái append-only kèm world state UTXO trên LevelDB; và
(4)~Blockchain Explorer là giao diện web React hiển thị dữ liệu theo
...
5.000 giao dịch mỗi giây, cùng phương pháp đo lường ba lớp (k6, submit,
