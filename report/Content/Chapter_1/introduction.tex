...
giá trị với doanh nghiệp và nhà nước: tính \textbf{minh bạch}, tính
\textbf{bất biến} và khả năng \textbf{kiểm toán} mà không cần một bên trung gian
...
triển hạ tầng blockchain quốc gia là khả năng xử lý \textbf{tối thiểu 5.000 giao
...
các nguyên lý thiết kế của chúng --- đặc biệt là việc \textbf{tự cài đặt thuật
...
\textbf{công khai} (public/permissionless) và blockchain \textbf{có cấp phép}
(permissioned).
...
Mục tiêu tổng quát của khóa luận là \textbf{thiết kế, hiện thực và đánh giá một
...
\begin{itemize}
  \item Tự cài đặt thuật toán đồng thuận \textbf{Raft} từ đầu (không dùng thư
  viện), bao gồm bầu lãnh đạo, nhân bản log, cắt block và đồng bộ --- với một
  biến thể bầu lãnh đạo theo độ ưu tiên.

  \item Xây dựng một máy ảo hợp đồng thông minh dựa trên \textbf{WebAssembly},
  cho phép viết hợp đồng bằng ngôn ngữ bậc cao và thực thi an toàn, xác định.

  \item Hiện thực mô hình xác nhận giao dịch \textbf{Execute--Order--Validate}
...
Để đảm bảo chiều sâu, khóa luận tập trung vào \textbf{luồng xử lý cốt lõi} của
...
--- nằm \textbf{ngoài phạm vi} trình bày, vì chúng là công cụ quản trị, không
